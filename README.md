...
* Exercise 2: Document the function
  ...
  * Exercise 2 and Exercise 1 are in the same code chunk because the documentation for a function has to come before the code for the function.
* Exercise 3: Include Examples
  * There are three examples showing how to use the mean_median_range function
      * Example 1 includes a custom data set with 14 numbers to show how the user can input specific numbers and calculate the mean, median and range of them.
...
* Exercise 4: Test The Function
    * This exercise involved four tests to show that the function is working as expected
        ...
        * The fourth test shows that the function produces an outcome with 4 values, which is the expected number.
